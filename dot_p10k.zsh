# Generated by Powerlevel10k configuration wizard on 2025-01-08 at 12:10 EST.
...
() {
  function prompt_mise() {
    ...
    for plugin in ${(k)plugins}; do
      ...
      local icon_var_name="${tool//-/_}_ICON"
      p10k segment -r -i "${icon_var_name}" -s $tool -t "$version"
    done
  }

  # Colors
  typeset -g POWERLEVEL9K_MISE_BACKGROUND=238
  typeset -g POWERLEVEL9K_MISE_FOREGROUND=7

  typeset -g POWERLEVEL9K_MISE_UV_BACKGROUND=238
  typeset -g POWERLEVEL9K_MISE_UV_FOREGROUND=7

  typeset -g POWERLEVEL9K_AWS_CLI_ICON=$' \ue7ad'
